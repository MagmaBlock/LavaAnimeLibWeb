          ...
          <n-spin :show="loading.year" class="mb-2">
            <div class="flex flex-wrap">
              ...
              <template v-if="loading.year">
                <div
                  class="inline-block w-[60px] h-7 m-0.5 bg-gray-300 dark:bg-zinc-800 animate-pulse"
                  v-for="a in 19"
                ></div>
              </template>
              <!-- 年份内容 -->
          ...
          <n-spin :show="loading.type">
            <div class="flex flex-wrap">
              ...
              <div class="leading-none" v-if="loading.type">
                <div
                  class="inline-block w-[50px] h-7 bg-gray-300 dark:bg-zinc-800 m-0.5 animate-pulse"
                  v-for="a in 8"
                ></div>
              </div>
              <!-- 分类内容 -->

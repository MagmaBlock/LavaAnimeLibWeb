<template>
  <div>
    ...
    <n-h3>新用户名</n-h3>
    <n-input-group>
      <n-input v-model:value="newName" placeholder="新用户名，1-30个字" type="text"/>
      <n-button secondary type="primary" @click="updateUserName(newName)">
        更改
      </n-button>
    </n-input-group>
    <n-alert class="mt-4" title="提示" type="info">

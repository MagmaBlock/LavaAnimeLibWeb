<template>
  <div class="h-20 grid place-items-center rounded-md relative
    ease-in transition shadow hover:shadow-lg border
    border-gray-200 dark:border-zinc-800 dark:bg-zinc-800">

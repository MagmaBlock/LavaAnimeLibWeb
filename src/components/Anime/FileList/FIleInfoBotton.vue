<template>
  ...
  >
    <div v-if="video.type == 'file'" class="cursor-pointer" @click="">
      <!-- 集数
      ...
      <span v-for="tag in video.tagedName" class="inline-flex">
        ...
        <n-tag
          v-if="typeof tag == 'object' && tag.type == 'source'"
          class="mx-0.5 my-0.5"
          type="success"
          size="small"
          :bordered="false"
        ...
        <n-tag
          v-if="typeof tag == 'object' && tag.type == 'quality'"
          class="mx-0.5 my-0.5"
          size="small"
          :bordered="false"
        >
        ...
        <n-tag
          v-if="typeof tag == 'object' && tag.type == 'language'"
          class="mx-0.5 my-0.5"
          type="info"
          size="small"
          :bordered="false"
        ...
        <n-tag
          v-if="typeof tag == 'object' && tag.type == 'other'"
          class="mx-0.5 my-0.5"
          type="warning"
          size="small"
          :bordered="false"
